 ...
 * @text アクターIDを代入する変数
 * @type variable
 * @desc 選択したアクターのアクターIDを受け取る変数です。
 * @default 30
 *
 * @param CancelChoiceMessage
 * @text キャンセルのテキスト
 * @type string
 * @desc cancelchoiceで追加できる、キャンセル用選択肢の表示文字列です。
 * @default キャンセル
 *
 * @help
 * 条件を満たすアクターのみで選択肢を作り、
 ...
 *      全てのアクターで選択肢を作ります。
 * ChoiceActors party
 *      パーティにいるアクターで選択肢を作ります。
 * ChoiceActors alive
 *      パーティにいて生存しているアクターで選択肢を作ります。
 * ChoiceActors dead
 *      パーティにいて死亡しているアクターで選択肢を作ります。
 *
 * ・追加プラグインコマンド(基本コマンドの直前に実行して下さい)
 * ChoiceActors 文
 *      選択肢の前に文を表示します。
 *      文の途中に半角スペースを入れる事で改行できます。
 * ChoiceActors nocance
 *      選択肢でのキャンセルを禁止します。
 * ChoiceActors position left
 *      選択肢を左側に表示します。
 * ChoiceActors position center
 *      選択肢を中央に表示します。
 * ChoiceActors back dark
 *      選択肢の背景を暗くします。
 * ChoiceActors back clear
 *      選択肢の背景を透明にします。
 * ChoiceActors cancelchoice
 *      選択肢の最後にキャンセル用選択肢を追加します。
